...
class TagCreationFlow(MessageFlow):
    def __init__(
        ...
        self.loop.create_task(
            message.reply(
                "Starting interactive tag creation. You can cancel anytime using $cancel. \nPlease send a message containing the link to the image."
            )
        )
    ...
    def step_1(self, message: discord.Message):
        ...
        return (
            True,
            "Next, send the name (not id) you want the tag to fall under i.e. maggus and not maggus69",
        )
    ...
    def step_2(self, message: discord.Message):
        ...
        return (
            True,
            "Next, enter a short description of the tag to make it easier to find",
        )
