...
class ClientTest(unittest.TestCase):
    ...
    def test_countdown_check(self):
        ...
        message_1 = Message(
            content="<@660689481984376843> 69420", channel=right_channel
        )
        message_2 = Message(
            content="<@660689481984376843> 69419", channel=right_channel
        )
        message_3 = Message(
            content="<@660689481984376843> 69420", channel=right_channel
        )
        message_4 = Message(
            content="<@660689481984376843> 69418", channel=wrong_channel
        )
